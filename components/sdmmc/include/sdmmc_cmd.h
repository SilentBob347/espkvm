...
/**
 * espkvm: called after every failed attempt of a DMA sector read or write, before
 * it is retried. Weak and empty here; an application overrides it.
 */
void sdmmc_espkvm_transfer_failed(sdmmc_card_t *card, bool write, esp_err_t err);

/**
 * espkvm: called as a DMA sector read or write starts. Weak and empty here.
 */
